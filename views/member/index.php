                        ...
                        <div class="padding_eight_all bg-white">
                            ...
                            <form   id="form">
                                <div class="form-group">
                                    <input type="email"  class="form-control" name="email" placeholder="Your Email Address" name="email"   data-field="email">
                                    <div class="valid-message"></div>
                                </div>
                                <div class="form-group">
                                    <input class="form-control"   type="password"  placeholder="Password" id="exampleInputPassword1" name="password" id="password" data-field="password">
                                    <div class="valid-message"></div>
                                </div>
                                <div class="login_footer form-group">
                                    ...
                                    <a href="<?php echo URL ?>Member/forgetPassword/">Forgot password?</a>
                                </div>
                                <div class="form-group">
...
<script src="<?php echo URL ?>ajax/js/login.js" type="text/javascript"></script>
