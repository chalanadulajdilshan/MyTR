        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item"><a href="<?PHP ECHO URL ?>">Member</a></li>
                        ...
                        <div class="padding_eight_all bg-white">
                            ...
                            <form   id="form">
                                <div class="form-group">
                                    <input type="text"  class="form-control" name="reset_code" placeholder="Your Reset Password"     data-field="reset_code">
                                    <div class="valid-message"></div>
                                </div>
                                <div class="form-group">
                                    <input type="password"  class="form-control" name="new_password" placeholder="New Password"    data-field="new_password">
                                    <div class="valid-message"></div>
                                </div>
                                <div class="form-group">
                                    <input type="password"  class="form-control" name="confirm_password" placeholder="Confirm Password"   data-field="confirm_password">
                                    <div class="valid-message"></div>
                                </div>
                                ...
                                <div class="login_footer form-group">
                                    ...
                                    <a href="<?php echo URL ?>Member/">Login?</a>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-fill-out btn-block"  >Verified</button>
                                    <div class="text-center text-danger btn-padding font-size-new" id="message" style="margin-top: 5px;"></div>

                                </div>
                                <input type="hidden" value="PasswordReset" name="PasswordReset">
                            </form>
                            ...
                            <div class="form-note text-center">Don't Have an Account? <a href="<?php echo URL ?>Member/singUp">Sign up now</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo URL ?>ajax/js/reset-password.js" type="text/javascript"></script>
