...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title Of Site -->
        <title>Tour Company || MyTravelPartner.lk</title>
    ...
    <body class="someBlock with-waypoint-sticky"> 
                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="travel-packages.php">Best Tour Companies</a></li>
                                            ...
                                            <div class="wrapper-inner"> 
                                                <div class="sidebar-title bg-primary">
                                                    <div class="d-flex align-items-end">
                                                        <div>
                                                            <h4 class="text-white font-serif font400">Filter Companies</h4>
                                                        </div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sidebar-box">
                                                    ...
                                                    <div class="box-title"><h5>Tour Types</h5></div>
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        foreach ($TOUR_TYPE->all() as $key => $tour_type) {
                                                            if ($key >= 2) {
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input common_selector tour_type" id="filerTourType<?php echo $tour_type['id'] ?>" name="filerTourType" value="<?php echo $tour_type['id'] ?>">
                                                                    <label class="custom-control-label" for="filerTourType<?php echo $tour_type['id'] ?>"><?php echo $tour_type['title'] ?><small class="text-muted font11">(<?php echo $TOUR_COMPANY_SELECTED_TOUR_TYPE->countTourCompanyByType($tour_type['id']) ?>)</small></label>
                                                                </div>
                                                                <?php
                                                            }
                                                        }
        ...
        <!--tour company filter-->
        <script src="<?php echo URL ?>js/ajax/tour-company-filter.js" type="text/javascript"></script>
