...
//            include './visitor/auth-tour-package.php';
//        }
//    } else {
//        include './visitor/auth-tour-package.php';
//    }
...
$TOUR_COMPANY_PACKAGE = new TourCompanyPackageSelected($id);
$TOUR_PACKAGE = new TourPackage($TOUR_COMPANY_PACKAGE->selected_package);
$TOUR_COMPANY = new TourCompany($TOUR_COMPANY_PACKAGE->tour_company);
?>
<html lang="en">
                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="tour-company.php">Tours</a></li> 
                                <li class="breadcrumb-item"><a href="view-tour-company.php?id=<?php echo $TOUR_COMPANY->id ?>"><?php echo $TOUR_COMPANY->title ?></a></li> 
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $TOUR_PACKAGE->title ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="row gap-30">
                            ...
                            <div class="col-12 col-lg-4 order-lg-last">
                                ...
                                <aside class="sticky-kit sidebar-wrapper">
                                            ...
                                            <div class="content-body">
                                                <div class="rating-item rating-sm rating-inline mb-7">
                                                    <div class="rating-icons"> 
                                                        <span class="material-icons star-size">    star   </span> <span class="material-icons star-size">    star   </span><span class="material-icons star-size">    star   </span><span class="material-icons star-size">    star   </span><span class="material-icons star-size">    star   </span>
                                                    </div> 
                                                </div>
                                                <h6><?php echo $TOUR_COMPANY->title ?></h6>
                                                <span class="meta text-muted"><i class="ion-location text-info"></i> <?php echo $TOUR_COMPANY->address_1 ?>, <?php echo $TOUR_COMPANY->city ?></span>
                                            </div>
                                            <div class="price">
                                                Start from <span class="text-secondary font700">$<?php echo $TOUR_COMPANY_PACKAGE->getMinPriceByTour($TOUR_COMPANY->id); ?></span> / Tour packages
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <div class="booking-selection-box disply-row" >

                                        <div class="content"> 
                                            <h5 class="font-serif font400"><?php echo $TOUR_PACKAGE->title ?> - Package</h5> 
                                            <p class="font-serif font400 text-primary "><?php
                                                $TOUR_TYPE = new TourType($TOUR_PACKAGE->tour_type);

                                                echo $TOUR_TYPE->title
                                                ?>  </p> 
                                            <p class="font-serif font400 text-justify "><?php echo substr($TOUR_COMPANY->description, 0, 160) ?> </p>
                                            <h5 class = "font-serif font400">Price</h5>
                                            <ul class = "summary-price-list">
                                                <li> <p > Package Price </p> <span class = "absolute-right price_stay">$<?php echo $TOUR_COMPANY_PACKAGE->price
                                                ?> </span></li>
    <!--                                                <li>taxes and fees <span class="absolute-right">$26.36</span></li>-->
                                                <li class="total">Total Price<span class="text-main absolute-right price_stay"> $<?php echo $TOUR_COMPANY_PACKAGE->price ?></span></li>
                                            </ul>
                            ...
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="payment-form-wrapper">
                                        ...
                                        <h3 class="heading-title"><span>" <?php echo $TOUR_PACKAGE->title ?> " - Package Booking Details</span></h3>
                                        ...
                                        <div class="bg-white-shadow pt-25 ph-30"> 
                                            <div class="row gap-20 mb-0 " id="airDatepickerRange-hotel" >
                                                ...
                                                <div class="col-3 col-12 col-sm-6">
                                                    <div class="form-group"> 
                                                        <label>Pickup Location</label>
                                                        <div class="form-icon-left">
                                                            <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                                                            <input type="text" id="check_out_date" class="form-control form-readonly-control  " name="check_out_date" placeholder="Enter Pick up Location">
                                                            <div class="col-12">
                                                ...
                                                <div class="col-3 col-12 col-sm-4">
                                                    <div class="form-group"> 
                                                        <label>Drop Location</label>
                                                        <div class="form-icon-left">
                                                            <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                                                            <input class="js-typeahead-country_v1 form-control" name="country" type="search" placeholder="Enter Drop Location" autocomplete="off">
                                                            <div class="col-12">
                                                                <span id="spanCheckOut" ></span>
                                                            </div>
                                                        </div>
