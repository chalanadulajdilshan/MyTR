                                            ...
                                            <div class="card-body">
                                                ...
                                                <fieldset>
                                                    <div class="br">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5>Fill Your Rent a Car Company Details - <small class="text-success">If you have not Company, Don't Worry fill this details.</small></h5>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <label> Company Name</label>
                                                                    <input type="text" class="form-control" placeholder="Enter the Company Name" id="title" name="title">
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </div>
