                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="card-body" style="margin-bottom: -10px;margin-top: -10px;">
                                        ...
                                        <center>
                                            <a href="update-transport.php"><button type="button" class="btn btn-icon btn-outline-primary "><i
                                                        class="bx bx-search"></i></button></a>
                                            <button type="button" class="btn btn-icon btn-outline-info" data-toggle="modal" data-target="#primary"><i class="bx bx-archive"></i></button>
                                            <div class="modal fade text-left" id="primary" tabindex="-1" role="dialog"
                                                 aria-labelledby="myModalLabel160" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary">
                                                            <h5 class="modal-title white" id="myModalLabel160">Manage Image</h5>
                                            ...
                                            <a href="update-transport-rate.php"><button type="button" class="btn btn-icon btn-outline-warning"><i class="bx bx-camera"></i></button></a>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body" style="margin-bottom: -10px;margin-top: -10px;">
                                        ...
                                        <center>
                                            <a href="update-transport.php"><button type="button" class="btn btn-icon btn-outline-primary "><i
                                                        class="bx bx-search"></i></button></a>
                                            <button type="button" class="btn btn-icon btn-outline-info"><i class="bx bx-archive"></i></button>
                                            <button type="button" class="btn btn-icon btn-outline-warning"><i class="bx bx-camera"></i></button>
                                            <button type="button" class="btn btn-icon btn-outline-danger">
                                                <i class="bx bx-like"></i></button>
                                        </center>
                                    </div>
