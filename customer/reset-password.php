...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
       ...
       <title>Manage Class - EasyTutor.lk</title>
                                        ...
                                        <div class="card disable-rounded-right mb-0   h-100 d-flex justify-content-center">
                                            <div class="card-header pb-1">
                                                <div class="card-title">
                                                    <center>
                                                        <a href="#">  <img class="img-fluid" src="app-assets/images/Logo.png" alt="mytravelpartner" width="80%"></a>
                                                    </center>
                                                </div>
                                            </div>
                                            <div class="card-content">
                                                <div class="card-body">
                                                    ...
                                                    <div class="divider">
                                                        <div class="divider-text text-uppercase text-muted"><small>  Reset Your Password </small>
                                                        </div>
                                                    </div>
                                                    <form action="" id="form">
                                                        <div class="form-group mb-50">
                                                            <label class="text-bold-600" for="exampleInputCode">Reset Code</label>
                                                            <input type="text" class="form-control" id="exampleInputCode" placeholder="Email Reset Code"  name="reset_code"   data-field="reset_code">
                                                            <div class="valid-message"></div>
                                                        </div>
                                                        <div class="form-group mb-50">
                                                            <label class="text-bold-600" for="exampleInputEmail1">New Password</label>
                                                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter New Password"  name="password"   data-field="new_password">
                                                            <div class="valid-message"></div>
                                                        </div>
                                                        <div class="form-group mb-50">
                                                            <label class="text-bold-600" for="exampleInputEmail1">Confirm Password</label>
                                                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Confirm Password"  name="confirm_password"   data-field="confirm_password">
                                                            <div class="valid-message"></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                                                            ...
                                                            <div class="text-right"><a href="sing-up.php"  class="card-link"><small>Sing Up?</small></a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="text-center text-danger btn-padding font-size-new" id="message"></div>

                                                        </div>
                                                        <button type="submit" class="btn btn-primary glow w-100 position-relative">Reset Now</button> 
                                                    </form>
                                                    <hr>
