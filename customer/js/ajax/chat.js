            ...
            success: function (result) {
                ...
                if (result) {
                    ...
                    if (result.image_name_visitor) {
                        img2 = '<img src="../upload/visitor/profile/' + result.image_name_visitor + '" alt="avatar" height="36" width="36" >';
                    } else {
                        img2 = '<img src="../images/member.jpg" alt="avatar" height="36" width="36">';
                    }

                    $.each(result.messages, function (key, message) {

                        key++;
                        if (message.customer == customer && message.type == 'C') {
