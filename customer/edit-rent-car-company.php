...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <div class="app-content content">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <fieldset>
                                                    <div class="br">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5>Edit Your Rent car Company Details - <small class="text-success">Edit your Rent car company name for customer. </small></h5>
                                                            </div>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="br mb-2">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <div class="radio">
                                                                        <input type="radio" value="1" name="agree" id="agree" <?php
                                                                        if ($RENT_CAR_COMPANY->agree == 1) {
                                                                            echo 'checked';
                                                                        }
                                                                        ?>>
                                                            ...
                                                            <button class="btn btn-primary" id="update" type="button" style="float: right;margin-top: -45px;">Update</button>
                                                        </div> 
                                                        <input type="hidden"   name="old-image_name" value="<?php echo $RENT_CAR_COMPANY->image_name ?>">
        ...
        <script src="js/ajax/rent-a-car-company.js" type="text/javascript"></script>
