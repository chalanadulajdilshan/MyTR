...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Menu Type || MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Menu Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Menu Type" id="title" name="title">
                                                                </div>
                                                            </div> 
                                            ...
                                            <div class="table-responsive">
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($MENU_TYPE->all() as $key => $tour_type) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $tour_type['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $tour_type['title'] ?></td>

                                                                <td>
                                                                    <a href="edit-tour-type.php?id=<?php echo $tour_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="create-menu.php?id=<?php echo $tour_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Create Menu" ><i class=" bx bx-dish   succes-btn"></i></a> | 
                                                                    <a href="#" class="delete-tour-type" data-id="<?php echo $tour_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
        ...
        <script src="js/ajax/menu_type.js" type="text/javascript"></script>
