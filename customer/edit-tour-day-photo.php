...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active"> <?php echo $TOUR_DATE->title ?>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                ...
                                                <fieldset> 
                                                    <div class="br mb-2"  >
                                                        ...
                                                        <div class="row" style="margin-top: 20px;">
                                                            ...
                                                            foreach ($TOUR_DATE_PHOTO->getTourDatePhotosById($id) as $tour_date_photo) {
                                                                ?>
                                                                <div class="col-md-3 col-sm-6" id="div<?php echo $tour_date_photo['id'] ?>">
                                                                    <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                        <div class="card" >
                                                                            <div class="card-content" >
                                                                                <a href="#" class="delete-tour-day-photo delete-btn-p" data-id="<?php echo $tour_date_photo['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 

                                                                                <img class="card-img-top img-fluid" src="../upload/tour-package/date/photo/thumb/<?php echo $tour_date_photo['image_name'] ?>" alt="mytravelpartner.lk" style="border-radius: 4px;" >
        ...
        <script src="delete/js/tour-day-photo.js" type="text/javascript"></script>
