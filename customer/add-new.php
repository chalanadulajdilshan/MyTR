                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card bg-transparent shadow-none border">
                                    <div class="card-header">
                                        <h4 class="card-title">Add Your Vehical</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-pills nav-fill">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link " id="profile-tab-fill" data-toggle="pill" href="#profile-fill"
                                                       aria-expanded="false">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-12">
                                                                                            <div class="form-label-group">
                                                                                                ...
                                                                                                <select id="first-name-floating" class="form-control" placeholder="Vehical Type"
                                                                                                        name="fname-floating">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="form-label-group">
                                                                                                <input type="text" id="email-id-floating" class="form-control" name="email-id-floating"
                                                                                                       placeholder="Title">
                                                                                                <label for="email-id-floating">Title</label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12">
                                                                                            <div class="form-label-group">
                                                                                                ...
                                                                                                <label for="contact-info-floating">Registration No</label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12">
                                                                                            <div class="form-label-group">
                                                                                                <input type="years" id="password-floating" class="form-control" name="contact-floating"
                                                                                                       placeholder="Registration Year">
                                                                                                <label for="password-floating">Registration Year</label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12">
                                                                                            <div class="form-label-group">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-label-group">
                                                                                                        <input type="file" name="" class="btn btn-primary form-control" >
                                                                                                        <label for="email-id-floating"></label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6 p-0" style="box-shadow: 3px 4px 3px rgba(0,0,0,0.4);margin-bottom:10px;">
                                                                                                    <div class="card" >
                                                                                                        <div class="card-content">
                                                                                                            <img src="app-assets/images/slider/10.png" class="card-img-top img-fluid" alt="singleminded">
                                                                                                            <div class="card-body">
                                                                                                                <button type="button" class="btn btn-icon rounded-circle btn-outline-danger mt-2 float-right"><i
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-label-group">
                                                                                                        <input type="Number" id="email-id-floating" class="form-control" name="email-id-floating"
                                                                                                               placeholder="Number Of Passengers">
                                                                                                        <label for="email-id-floating">Number Of Passengers</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-label-group">
                                                                                                        <input type="Number" id="contact-info-floating" class="form-control" name="contact-floating"
                                                                                                               placeholder="Number Of Badgage">
                                                                                                        <label for="contact-info-floating">Number Of Badgage</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-label-group">
                                                                                                        ...
                                                                                                        <label for="email-id-floating">Number Of Doors</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6">
                                                                                                    <div class="">
                                                                                                        <label>Air Condition</label><br>
                                                                                                        <input type="radio" name="r"> Yes
