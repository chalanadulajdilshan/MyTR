                                            ...
                                            <fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Restaurant Name" name="title" id="title" value="<?php echo $REASTURANT->title ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="address_1" name="address_1" placeholder="Unit Number, suite floor, Bulding" value="<?php echo $REASTURANT->address_1 ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Address Line 2</label>
                                                                <input type="text" class="form-control" id="address_2" name="address_2" placeholder="Street name" value="<?php echo $REASTURANT->address_2 ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <input type="text" class="form-control" name="zip_code" id="zip_code" placeholder="Enter Your Zip code" readonly="" value="<?php echo $CITY_ZIP->postcode ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">  
                                                        ...
                                                        <div class="col-sm-4 col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Enter Contact name" value="<?php echo $REASTURANT->contact_name ?>" name="contact_name" id="contact_name">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-md-3">
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="email" class="form-control" placeholder="Enter your email" value="<?php echo $REASTURANT->email ?>" name="email" id="email">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4  col-md-3">
                                                            <div class="form-group">
                                                                <label> Contact number</label>
                                                                <input type="text" class="form-control mobile_number" placeholder="Enter Contact number " value="<?php echo $REASTURANT->contact_number ?>" id="contact_number" name="contact_number">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4  col-md-4">
                                                            <div class="form-group">
                                                                <label>Alternative contact number (optional) </label>
                                                                <input type="text" class="form-control mobile_number" placeholder="Enter Contact number " id="contact_number_2" name="contact_number_2"  value="<?php echo $REASTURANT->contact_number_2 ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="br mb-2">
                                                    <div class="row">  
                                                        <div class="col-sm-4" id="show-btn"> 
                                                            ...
                                                            <input type="hidden" id="del-restaurant-img" name="image_name" value="<?php echo $REASTURANT->main_image ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6  ">
                                                        ...
                                                        <input type="hidden"   name="old-image_name" value="<?php echo $REASTURANT->main_image ?>">
