...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Offer - MyTravelPartner.lk</title>
                                                ...
                                                <div class="row"> 
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="category" id="category">
                                                                <option value="" selected="">Select Your offer type</option>
                                                                <?php
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter offer precentage" id="offer_presentage" name="offer_presentage">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="offer_duration" id="offer_duration" disabled="">
                                                                <option value="" selected="">Select offer duration</option>
                                                                <?php
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter end Date" id="end_date" name="end_date" readonly="">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Price</label>
                                                            <input type="text" class="form-control" placeholder="Enter price" id="price" name="price" readonly="">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12"  > 
                                                        <label>Offer Image <b><span class="text-danger text-uppercase">Please use this image size ( 255px * 300px )</span></b></label>
                                    ...
                                    <div class="br"> 
                                        <div class="row">
                                            ...
                                            if (count($OFFER->all()) > 0) {
                                                        ...
                                                        <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                            <div class="card" >
                                                                <div class="card-content" > 
                                                                    <img class="card-img-top img-fluid" src="../upload/offer/<?php echo $offer['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                    <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                        <h6 class=" text-left"><?php echo $offer['title'] ?></h6>
                                                                        <a href="edit-offer.php?id=<?php echo $offer['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                        <a href="arrange-offer.php"  data-toggle="tooltip" data-placement="bottom" title="Arrange"><i class=" bx bx-transfer succes-btn"></i></a> | 
                                                                        <a href="#" class="delete-offer" data-id="<?php echo $offer['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                ?>
                                                <p class="text-danger text-bold-600 text-left">No offers now.. .</p>
                                            <?php } ?>
                                        </div>
                                    </div>  
                                </div>
