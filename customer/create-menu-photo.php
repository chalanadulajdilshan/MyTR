...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Menu Photo ||  MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                ...
                <div class="content-header row">
                    <div class="content-header-left col-12 mb-2 mt-1">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h5 class="content-header-title float-left pr-1 mb-0">Menu Photo</h5>
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        <li class="breadcrumb-item"><a href="index.php"><i class="bx bx-home-alt"></i></a>
                                        </li>

                                        <li class="breadcrumb-item active"> <?php echo $MENU->title ?>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                ...
                                                <fieldset> 
                                                    <div class="br mb-2"  >                                                      
                                                        <div class="row"> 
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <label>Add Menu Images</label>
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="add-menu-img" name="image_name">
                                                                        <label class="custom-file-label" for="add-menu-img">Add Your Menu Image</label>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        ...
                                                        <div class="row" style="margin-top: 20px;">
                                                            ...
                                                            foreach ($MENU_PHOTO->getMenuPhotosById($id) as $menu_photo) {
                                                                ?>
                                                                <div class="col-md-3 col-sm-6" id="div<?php echo $menu_photo['id'] ?>">
                                                                    <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                        <div class="card" >
                                                                            <div class="card-content" >
                                                                                <a href="#" class="delete-menu-photo delete-btn-p" data-id="<?php echo $menu_photo['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                              
                                                                                <img class="card-img-top img-fluid" src="../upload/restaurant/menu/thumb/<?php echo $menu_photo['image_name'] ?>" alt="mytravelpartner.lk" style="border-radius: 4px;" >
        ...
        <!-- END: Page Vendor JS-->
        <script src="js/ajax/menu-photo.js" type="text/javascript"></script>
        <script src="delete/js/menu-photo.js" type="text/javascript"></script>
