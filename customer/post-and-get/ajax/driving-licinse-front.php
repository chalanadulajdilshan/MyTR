...
if ($_POST['selected_option_1'] == 'licen_front') {

    $dir_dest = '../../../upload/rent-a-car/license/front/';
    $dir_dest_thumb = '../../../upload/rent-a-car/license/front/thumb/';

    $imgName = Helper::randamId();

    $handle = new Upload($_FILES['licen_front']);
...
//        $handle->image_watermark = '../../img/logo-watermark.png';
        ...
        if ($handle->processed) {
            ...
            $handle1 = new Upload($_FILES['licen_front']);
