...
if ($CUSTOMER->checkEmail($email)) {
    ...
    if ($CUSTOMER->GenarateCode($email)) {
        $res = $CUSTOMER->SelectForgetUser($email);
        ...
        $html .= "<tr><th colspan='3' style='font-size: 18px; padding: 30px 25px 0 25px; color: #fff; text-align: center; background-color: #4184F3;'><h2>MyTravelPartner.lk</h2> </th> </tr>";
