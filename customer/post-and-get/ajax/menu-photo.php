...
if ($_POST['action'] == 'upload-add-image') {
    ...
    $dir_dest = '../../../upload/restaurant/menu/';
    $dir_dest_thumb = '../../../upload/restaurant/menu/thumb/';
...
if ($_POST['action'] == 'delete') {
    ...
    unlink('../../../upload/restaurant/menu/' . $_POST['id']);
    unlink('../../../upload/restaurant/menu/thumb/' . $_POST['id']);
