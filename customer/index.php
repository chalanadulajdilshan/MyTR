...
$COUNT_ACCOMMODATION = count($ACCOMMODATION->getAccommodationCustomer($_SESSION['id']));
$COUNT_TOUR_COMPANY = count($TOUR_COMPANY->getToursByCustomer($_SESSION['id']));
$COUNT_RENT_CAR_COMPANY = count($RENT_CAR_COMPANY->getCompanyByCustomer($_SESSION['id']));
$COUNT_RESTAURANT = count($RESTAURANT->getRestaurantByCustomer($_SESSION['id']));
?>
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="total-amount">
                                               ...
                                               <small class="text-muted  ">Nu of Restaurants<span class="text-danger"><b> <?php echo $COUNT_RESTAURANT ?></b></span></small>
                                            </div>
                                        </div>
                                        <div id="primary-line-chart"></div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="create-restaurant.php" class="btn btn-outline-primary w-100">Add Restaurants</a>
                                        </div>
                                    </div>
                                </div>
                            </div> 
