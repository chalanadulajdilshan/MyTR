                                            ...
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                    ...
                                                    <div class="br mb-2"  >
                                                        ...
                                                        <div class="row"> 
                                                            <div class="col-12">
                                                                <h5>Add Your Vehicle Other Images <small class="text-danger">(Please add more than 5 Images)</small></h5>
                                                            </div>
                                                        </div>
                                                        <div class="row"> 
                                                            <div class="col-sm-4">
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="update-car-image" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Update
                                                    </button>
                                                    <input type="hidden" name="action" value="upload-add-image">
                                                    <input type="hidden" name="update-img"  >
