...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Tour Date - MyTravelPartner.lk</title>
                                            ...
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                    <div class="br">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5>Edit Your Tour Dates - <small class="text-success">Edit your tour date.  </small>
                                                                </h5>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Your date (Ex: Day 1)" id="title" name="title" value="<?php echo $TOUR_DATE->title?>">
                                                                </div>
                                                            </div>                                       
                                                        </div>         
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-lg-12 col-md-12 col-sm-4 col-xs-5 form-control-label">
                                                                ...
                                                                <textarea id='description' name="description" style="background: white;"> <?php echo $TOUR_DATE->description?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>  
                                                    <hr>
