                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    ...
                                                    <div class="divider">
                                                        ...
                                                        <div class="text-muted text-cente mt-2  "  >  <small class="text-danger text-bold-600">Please Check your Mobile Number <a href="" class="text-bold-700  "><?php echo $CUSTOMER->phone_number ?></a>   and enter</br> the verification code for active your account ..!</small></div>
