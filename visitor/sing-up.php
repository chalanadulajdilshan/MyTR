                            ...
                            <div class="card bg-authentication mb-0">
                                <div class="row m-0">
                                                    ...
                                                    <form action="" id="form">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6 mb-50">
                                                                <label  class="text-bold-600"  for="inputfirstname4">first name</label>
                                                                <input type="text" class="form-control" id="inputfirstname4"  placeholder="First name"  name="first_name" data-field="first_name">
                                                                <div class="valid-message"></div>
                                                            </div>
                                                            <div class="form-group col-md-6 mb-50">
                                                                <label  class="text-bold-600"  for="inputlastname4">last name</label>
                                                                <input type="text" class="form-control" id="inputlastname4" placeholder="Last name"  name="last_name" > 
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-50">
                                                            <label class="text-bold-600" for="exampleInputUsername1">Mobile Number</label>
                                                            <input type="text" class="form-control phone-inputmask" id="exampleInputUsername1" placeholder="Mobile Number" name="mobile_number" data-field="mobile_number"  >
                                                            <div class="valid-message"></div>
                                                        </div>
                                    ...
                                    <div class="col-md-6 d-md-block d-none text-center align-self-center  " style="padding:0px;">
                                        <img class="img-fluid img-b-radius" src="app-assets/images/pages/register.png" alt="branding logo" >
                                    </div>
                                </div>
                            </div>
                        </div>
