                        ...
                        <div class="chat-sidebar card">
                                    ...
                                    <div class="chat-sidebar-profile-toggle">
                                        <div class="avatar">
                                            ...
                                            if (empty($VISITOR->image_name)) {
                                                ?>
                                                <img src="../images/member.jpg" alt="<?php echo $VISITOR->full_name ?>" height="36" width="36">


                                            <?php } else { ?>
                                                <img src="../upload/visitor/profile/<?php echo $VISITOR->image_name ?>" alt="<?php echo $VISITOR->full_name ?>" height="36" width="36">
                            ...
                            <div class="chat-sidebar-list-wrapper pt-2">
                                ...
                                <ul class="chat-sidebar-list">
                                    <?php
                                    $allparticipants = VisitorMessage::getDistinctCustomer($VISITOR->id);

                                    if ($allparticipants) {
                                        $maxids = array();
                                        foreach ($allparticipants as $participant) {
                                            $result = VisitorMessage::getLatestChatIdVisitor($VISITOR->id, $participant['customer']);
                                            array_push($maxids, $result['id']);
                                        }
                                        rsort($maxids);
                                        foreach ($maxids as $maxid) {
                                            $MSG = new VisitorMessage($maxid);
                                            $CUST = new Customer($MSG->customer);
                                            ?>


                                            <li  customer="<?php echo $CUST->id ?>" visitor="<?php echo $VISITOR->id; ?>" class="data chat-participant">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar m-0 mr-50">
                                                        <?php
                                                        if (empty($CUST->image_name)) {
                                                            ?>
                                                            <img src="../images/member.jpg" height="36"   width="36" alt="<?php echo $CUST->full_name ?>">
                                                        <?php } else { ?>
                                                            <img src="../upload/customer/profile/<?php echo $CUST->image_name ?>" height="36"   width="36" alt="<?php echo $CUST->full_name ?>">
                                                            <?php
                                                        }

                                                        if (Helper::checkIsOnline($CUST->lastLogin)) {
                                                            ?>
                                                    ...
                                                    <div class="chat-sidebar-name">
                                                        <h6 class="mb-0"><?php echo $CUST->full_name ?></h6><span class="text-muted"><?php echo date_format(date_create($CUST->lastLogin), "M/d - h:i A") ?></span>
                                                    </div>
                                                </div>
                                            </li>  
                                            <?php
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="content-body"><!-- app chat overlay -->
                            ...
                            <section class="chat-window-wrapper"  >
                                ...
                                if ($allparticipants) {
                                    foreach ($allparticipants as $participant) {
                                        $CUSTOMER_FEACH = new Customer($participant['customer']);
                                        ?>
                                        <div class="chat-area  " id="div<?php echo $CUSTOMER_FEACH->id ?>">
                                                ...
                                                <header class="d-flex justify-content-between align-items-center border-bottom px-1 py-75">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="avatar chat-profile-toggle m-0 mr-1">
                                                            <?php
                                                            if (empty($CUSTOMER_FEACH->image_name)) {
                                                                ?>
                                                                <img src="../images/member.jpg" height="36"   width="36" alt="<?php echo $CUSTOMER_FEACH->full_name ?>">
                                                            <?php } else { ?>
                                                                <img src="../upload/customer/profile/<?php echo $CUSTOMER_FEACH->image_name ?>" height="36"   width="36" alt="<?php echo $CUSTOMER_FEACH->full_name ?>">
                                                            <?php }
                                                            ?>
                                                            <span class="avatar-status-busy"></span>
                                                        </div>
                                                        <h6 class="mb-0 chat-visitor-name"><?php echo $CUSTOMER_FEACH->full_name ?></h6>
                                                    </div>
                                            ...
                                            <div class="  chat-wrapper shadow-none">
                                                <div class="card-content">
                                                    <div class="card-body chat-container" id="div<?php echo $CUSTOMER_FEACH->id ?>">
                                                        <div class="chat-content " id="chat-list">
                                                          ...
                                                          <span id="type<?php echo $CUSTOMER_FEACH->id ?>"></span>
                                                    </div>

                                                </div>
                                                <div class="card-footer chat-footer border-top px-2  pb-0 mb-1" style="margin-top: -20px;"> 
                                                    <form class="d-flex align-items-center" onsubmit="chatMessagesSend();" action="javascript:void(0);">  
                                                        <input type="text" class="form-control chat-message-send mx-1 place-emj chat_message" style="margin-top: 5px;"placeholder="Type your message here...">
                                                        ...
                                                        <input type="hidden" value="<?php echo $customer; ?>" id="customer"> 
                                                        <input type="hidden" value="<?php echo $VISITOR->id ?>" id="visitor">
