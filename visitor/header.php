            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <?php } else { ?>
                                <div class="avatar">
                                    <img   src="../upload/visitor/profile/<?php echo $VISITOR->image_name ?>" alt="avatar" class="main-img round" width="40" height="40">
                                    <span class="avatar-status-online"></span>
                                </div> 
                            <?php } ?>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right pb-0">
                            <a class="dropdown-item" href="page-user-profile.html"><i class="bx bx-user mr-50"></i> My Dashboard</a>
                            ...
                            <a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i> My Reviews</a>
                            <a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i> Settings</a>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="index.php">
                    <img src="app-assets/images/logo-white.png" width="100%">
                </a >
            </li> 
        </ul>
    </div>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class=" nav-item p-a-15 p-t-27"> 
                <a href="index.php">  
...
<!--            <li class=" nav-item p-a-15 ">                                                                                                                                             
                <a href="#"> <span class="bx bxs-map  ">  Tour Packages</span>   </a>
                <ul class="menu-content">
...
<!--            <li class=" nav-item p-a-15 ">                                                                                                                                             
                ...
                <ul class="menu-content">
                    <li ><a href="create-rent-car.php"><i class="bx bx-right-arrow-alt"></i> Add New  </a>
                    </li>
                    <li><a href="manage-rent-car.php"><i class="bx bx-right-arrow-alt"></i>  Manage </a>
                    </li>
                </ul>
            </li>-->
            ...
            <li class=" nav-item  p-a-15">                                                                                                                                             
                <a href="#"><span class="bx bx-calendar-event  "> <span class="menu-title" data-i18n="Dashboard">My Bookings</span>   <span class="badge badge-light-danger badge-pill badge-round  ">2</span>   </a>
                <ul class="menu-content">
                    <li ><a href="hotel-bookings.php"><i class="bx bx-right-arrow-alt"></i> Hotels  <span class="badge badge-light-danger badge-pill badge-round float-right ml-2">2</span>  </a>
                    </li>
                    <li><a href="manage-accommodation.php"><i class="bx bx-right-arrow-alt"></i>  Manage </a>
                    </li>
                </ul>
            ...
            <li class=" nav-item p-a-15"> 
                <a href="create-messenger.php">  
                    <span class="bx bx-crosshair  "> Message</span>   
                </a> 
