                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                ...
                                                                <div style="margin-top: 6px;">
                                                                    <input id="rating-input" type="text" name="star_rating" class="form-control star_rating" >
                                                                </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="8" class="form-control" id="review" name="review"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 d-flex justify-content-end">
                                                            <button type="submit" class="btn btn-primary mr-1 mb-1" id="create">Submit</button>
                                                            <button type="reset" class="btn btn-light-secondary mr-1 mb-1">Reset</button>
                                                            <input type="hidden" value="validate_booking_id" name="validate_booking_id">
                                                            <input type="hidden" value="create" name="create">
                                                           
                                                            <input type="hidden" value="<?php echo $_SESSION['id'] ?>" name="visitor">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                ...
                                <div id="searchResults" class="py-0 search-results">
                                    <div class="web-result">
                                        <ul class="list-unstyled">
                                            ...
                                            foreach ($GUEST_REVIEWS->getReviewsByVisitorIdAndAccType($_SESSION['id']) as $guest_reviews) {
                                                $ACC_ID = $ACCOMMODATION_BOOKING ->getIdByBookingId($guest_reviews['booking_id']);
