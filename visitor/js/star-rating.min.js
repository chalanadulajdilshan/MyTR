    ...
    (t = {
        ...
        handler: function (e, a, n, i, r) {
            ...
            (a.prototype = {
                ...
                _initSlider: function (e) {
                    ...
                    (a.initialValue = t.isEmpty(n) ? 0 : n),
                            ...
                            (isNaN(a.step) || t.isEmpty(a.step) || 0 === a.step) && (a.step = t.DEFAULT_STEP),
                            (a.diff = a.max - a.min);
                },
                ...
                _generateRating: function () {
                    ...
                    (n = r.$container = e(document.createElement("div")).insertBefore(l)),
                            ...
                            (r.$rating = a = e(document.createElement("div")).attr("class", "rating-stars").appendTo(n).append(r._getStars("empty")).append(r._getStars("filled"))),
                            ...
                            r._initCaptionTitle(),
                            n.append(l),
                            r.rtl && ((i = Math.max(r.$emptyStars.outerWidth(), r.$filledStars.outerWidth())), r.$emptyStars.width(i)),
                            l.appendTo(a);
                },
                ...
                _renderClear: function () {
                    ...
                    if (n.showClear) {
                        if (((a = n._getClearClass()), i.length))
                            return t.addCss(i, a), i.attr({title: n.clearButtonTitle}).html(n.clearButton), void (n.$clear = i);
                ...
                _toggleHover: function (e) {
                    var t,
                            ...
                            i = this;
                    e &&
                            (i.hoverChangeStars && ((t = i.getWidthFromValue(i.clearValue)), (a = e.val <= i.clearValue ? t + "%" : e.width), i.$filledStars.css("width", a)),
                                    i.hoverChangeCaption && ((n = e.val <= i.clearValue ? i.fetchCaption(i.clearValue) : e.caption), n && i._setCaption(n + "")));
                },
                _init: function (t) {
                    var a,
                            n = this,
                    ...
                    return (
                            ...
                            (n.rtl || "rtl" === i.attr("dir")) && ((n.rtl = !0), i.attr("dir", "rtl")),
                            (n.starClicked = !1),
                            (n.clearClicked = !1),
                            n._initSlider(t),
                            n._checkDisabled(),
                            n.displayOnly && ((n.inactive = !0), (n.showClear = !1), (n.hoverEnabled = !1), (n.hoverChangeCaption = !1), (n.hoverChangeStars = !1)),
                            n._generateRating(),
                            n._initEvents(),
                            n._listen(),
                    ...
                    e.events = {
                        ...
                        initTouch: function (a) {
                            ...
                            p &&
                                    ...
                                    ((n = a.originalEvent),
                                            ...
                                            "touchend" === a.type
                                            ? (e._setStars(r), (u = [e.$element.val(), e._getCaption()]), e._trigChange(u), (e.starClicked = !0))
                                            : ((l = e.calculate(r)), (s = l.val <= d ? e.fetchCaption(d) : l.caption), (o = e.getWidthFromValue(d)), (c = l.val <= d ? o + "%" : l.width), e._setCaption(s), e.$filledStars.css("width", c)));
                        },
                        ...
                        clearMouseMove: function (t) {
                            ...
                            !e.events._noMouseAction(t) &&
                                    e.hoverOnClear &&
                                    ((e.clearClicked = !1),
                                            (a = '<span class="' + e.clearCaptionClass + '">' + e.clearCaption + "</span>"),
                                            (n = e.clearValue),
                ...
                _listen: function () {
                    var a = this,
                            ...
                            s = a.events;
                    return (
                            t.handler(r, "touchstart touchmove touchend", e.proxy(s.initTouch, a)),
                            ...
                            a.showClear && l.length && (t.handler(l, "click touchstart", e.proxy(s.clearClick, a)), t.handler(l, "mousemove", e.proxy(s.clearMouseMove, a)), t.handler(l, "mouseleave", e.proxy(s.clearMouseLeave, a))),
                ...
                fetchCaption: function (e) {
                    ...
                    return (
                            o && o !== s.clearValue && (o = t.applyPrecision(o, t.getDecimalPlaces(s.step))),
                        ...
                        (i.shift(),
                                ...
                                o ||
                                        (u && (p = e.fn.ratingThemes[u] || {}),
                                                "en" === d || t.isEmpty(e.fn.ratingLocales[d]) || (h = e.fn.ratingLocales[d]),
                                                (l = e.extend(!0, {}, e.fn.rating.defaults, p, e.fn.ratingLocales.en, h, c, s.data())),
                                                (o = new a(this, l)),
                                                s.data("rating", o)),
            ...
            (e.fn.rating.defaults = {
                ...
                language: "en",
                stars: 5,
                filledStar: '<i class="bx bxs-star" style="font-size: 24px;"></i>',
                emptyStar: '<i class="bx bx-star" style="font-size: 24px;"></i>',
                containerClass: "",
                size: "md",
                animate: !0,
                displayOnly: !1,
            ...
            (e.fn.ratingLocales.en = {
                ...
                starCaptions: {0.5: "Half Star", 1: "Terrible", 1.5: "One & Half Star", 2: "Poor", 2.5: "Two & Half Stars", 3: "Average", 3.5: "Three & Half Stars", 4: "Very Good", 4.5: "Four & Half Stars", 5: "Excellent"},
