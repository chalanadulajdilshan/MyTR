...
$id = '';
$id = $_GET['id'];
$GUEST_REVIEWS = new GuestReview($id);
?>
<html lang="en">
    <head>
                            ...
                            <div class="col-lg-8 col-md-7 col-12 order-2 order-md-1 " id="sc-bar">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title text-success">Edit your booking review here.</h4>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <div class="form-group">
                                                                <label for="first-name-vertical"> Booking Id - <span class="text-danger">Use the correct Booking ID format (BOOKING-00#)</span></label>
                                                                <input type="text" id="booking_id" class="form-control" name="booking_id"   placeholder="Enter your Booking Id" value="<?php echo $GUEST_REVIEWS->booking_id ?>" readonly="">
                                                            </div>
                                                        </div>
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                ...
                                                                <div style="margin-top: 6px;">
                                                                    <input id="rating-input" type="text" name="star_rating" class="form-control star_rating" value="<?php echo $GUEST_REVIEWS->starts ?>" >
                                                                </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="title" class="form-control" name="title"  placeholder="Enter your Review Title" value="<?php echo $GUEST_REVIEWS->title ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="8" class="form-control" id="review" name="review"><?php echo $GUEST_REVIEWS->review ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 d-flex justify-content-end">
                                                            <button type="submit" class="btn btn-primary mr-1 mb-1" id="update">Update</button>
                                                             <input type="hidden" value="create" name="update">
