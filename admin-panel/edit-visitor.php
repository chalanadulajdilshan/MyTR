...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Visitor - MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
        ...
        <div class="app-content content">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Visitor 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"   id="full_name" name="full_name" value="<?php echo $VISITOR->full_name ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter Email" id="email" name="email"  value="<?php echo $VISITOR->email ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Phone Number</label>
                                                                    <input type="number" min="0" class="form-control"   id="phone_number" name="phone_number"  value="<?php echo $VISITOR->phone_number ?>">
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                ...
                                                                if (empty($VISITOR->image_name)) {
                                                                    ?>
                                                                    <img src="../images/member.jpg" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;"/>
                                                                <?php } else { ?>
                                                                    <img src="../upload/visitor/<?php echo $VISITOR->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2; "/>
            ...
            <script src="js/ajax/visitor.js" type="text/javascript"></script>
