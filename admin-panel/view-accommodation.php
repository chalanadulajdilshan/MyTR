...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">View Accommodation
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                    ...
                                    <div class="card icon-tab">
                                        ...
                                        <div class="card-content mt-2">
                                            <h3 class="text-center mt-1">
                                                ...
                                                <span>View Accommodation - <em class="text-danger">" <?php echo $ACCOMMODATION->title ?> " </em></span>
                                            </h3>
                                            <div class="card-body">
        ...
        <footer class = "footer footer-static footer-light">
            <p class = "clearfix mb-0"><span class = "float-left d-inline-block">2020 &copy;
                    PIXINVENT</span><span class = "float-right d-sm-inline-block d-none">Crafted with<i class = "bx bxs-heart pink mx-50 font-small-3"></i>by<a class = "text-uppercase" href = "https://1.envato.market/pixinvent_portfolio" target = "_blank">Pixinvent</a></span>
        ...
        <script src="js/ajax/add-facility.js" type="text/javascript"></script>
        <!-- BEGIN: Page JS-->
