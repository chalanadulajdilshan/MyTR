...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>View Room - <?php echo $ROOM->title ?> || MyTravelPartner.lk</title>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-inline-block mb-1 mr-1">
                                                                        <input type="number" class="touchspin" value="1" name="num_of_rooms" value="<?php echo $ROOM->no_of_rooms ?>">
                                                                    </div>
                                                                </div>
                                                            </div>                                       
                                                            <div class="col-sm-4">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-inline-block mb-1 mr-1">
                                                                        <input type="number" class="touchspin"  value="<?php echo $ROOM->max ?>" name="max" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <fieldset class="form-group">
                                                                        <input type="number" class="touchspin" data-bts-prefix="US$" name="price" value="<?php echo $ROOM->price ?>">
                                                                    </fieldset> 
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3">
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                foreach ($AMENITIES->getAmenitiesById($amenities_type['id']) as $key => $amenitie) {
                                                                                                    ...
                                                                                                    <div class="col-md-3 mb-1">
                                                                                                        <div class="checkbox checkbox-primary">
                                                                                                            <input type="checkbox" id="colorCheckboxm2<?php echo $key ?>"   name="amenities[]" value="<?php echo $amenitie['id'] ?>" <?php
                                                                                                            foreach (explode(",", $ROOM->amenities) as $amenities) {
                                                                                                                if ($amenities == $amenitie['id']) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            ...
                                                                                                            ?>  >
                                                                                                            <label for="colorCheckboxm2<?php echo $key ?>"><?php echo $amenitie['title'] ?></label>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                <?php } ?>
                                                                                            </div>
