...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Slider - MyTravelPartner</title>
                                                ...
                                                <fieldset>
                                                    <div class="br">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12"  > 
                                                                <label>Your slier Image</label>
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input" id="image_name" name="image_name">
                                                                    <label class="custom-file-label" for="main_img_tour">Slider image</label>
                                                                </div> 
                                                            </div>  
                                                        </div>  
                                                    </div>  
                                                ...
                                                <div class="row">
                                                    ...
                                                    if (count($SLIDER) > 0) {
                                                        foreach ($SLIDER->all() as $key => $slider) {
                                                            ?>
                                                            <div class="col-md-3 col-sm-6" id="div<?php echo $slider['id'] ?>">
                                                                <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                    <div class="card" >
                                                                        <div class="card-content" > 
                                                                            <img class="card-img-top img-fluid" src="../upload/slider/<?php echo $slider['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                            <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                                <h6 class=" text-left"><?php echo $slider['title'] ?></h6>
                                                                                <a href="edit-slider.php?id=<?php echo $slider['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                                <a href="arrange-slider.php"  data-toggle="tooltip" data-placement="bottom" title="Arrange"><i class=" bx bx-transfer succes-btn"></i></a> | 
                                                                                <a href="#" class="delete-slider" data-id="<?php echo $slider['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        ?>
                                                        <p class="text-danger text-bold-600 text-left">No slider images.</p>
                                                    <?php } ?>
                                                </div>
                                            </div>  
                                        </div>
