...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage District - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage Districts
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($DISTRICTS->all() as $key => $district) {
                                                            ...
                                                            <tr id="div<?php echo $district['id'] ?>">
                                                                ...
                                                                <td>
                                                                    <a href="create-cities.php?id=<?php echo $district['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Add City" ><i class=" bx bx-map-pin  info-btn"></i></a> 
