...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage All Tour Company - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage All Tour Company
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($TOUR_COMPANY->all() as $key => $tour_company) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $tour_company['id'] ?>">
                                                                <td><?php echo $key ?></td>

                                                                <td><?php echo $tour_company['title']; ?> </td>
                                                                <td><?php echo $tour_company['contact_name']; ?></td>
                                                                <td><?php echo $tour_company['contact_number_1']; ?></td>
                                                                <td><?php echo $tour_company['email']; ?></td>
                                                                <?php
                                                                if ($tour_company['is_publish'] == 0) {
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    <a href="edit-tour-company.php?id=<?php echo $tour_company['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-tour-company" data-id="<?php echo $tour_company['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
