...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Tour Type - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Tour Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Tour Type" id="title" name="title">
                                                                </div>
                                                            </div> 
                                                        ...
                                                        foreach ($TOUR_TYPE->all() as $key => $tour_type) {
                                                            ...
                                                            <tr id="div<?php echo $tour_type['id'] ?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="manage-tour-package.php?id=<?php echo $tour_type['id'] ?>" data-toggle="tooltip" data-placement="View Tour Packages" title="Edit" ><i class=" bx bxs-map-alt   succes-btn"></i></a> | 
