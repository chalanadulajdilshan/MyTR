...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Vehicle Type - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Vehicle Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Vehicle Type" id="title" name="title" value="<?php echo $VEHICLE_TYPE->title ?>">
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="update-vehicle-type" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Update
                                                    </button>
                                                    <input type="hidden" id="id" value="<?php echo $id ?>" name="id">
                                                    <input type="hidden"  name="update-vehicle-type"> 
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
