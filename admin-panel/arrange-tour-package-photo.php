...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Tour Package Photos - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Tour Package Photo </a>
                                        </li>
                                        <li class="breadcrumb-item active">Arrange Tour Package Photo
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/tour-package-photo.php" method="POST" > 
                                                ...
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        ...
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $tour_package_photo['caption'] ?></h6>
                                                            <input type="hidden" name="sort[]"  value="<?php echo $tour_package_photo["id"]; ?>" class="sort-input"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
