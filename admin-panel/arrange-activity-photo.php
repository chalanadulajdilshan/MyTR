...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Activities Photos - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Activities Photos </a>
                                        </li>
                                        <li class="breadcrumb-item active">Arrange Activities Photos
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/activity-photo.php" method="POST" > 
                        <section id="draggable-cards">
                            <div class="row" id="card-drag-area">  
                                <?php
                                $ACTIVITY_PHOTO = new ActivitiesPhoto(NULL);
                                if (count($ACTIVITY_PHOTO->getActivitiesPhotosById($id)) > 0) {

                                    foreach ($ACTIVITY_PHOTO->getActivitiesPhotosById($id) as $key => $activity_photo) {
                                        ?>
                                        <div class="col-md-3 col-sm-6"  >
                                            <div class="back-basic-color">
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        <img class="card-img-top img-fluid" src="../upload/activity/gallery/thumb/<?php echo $activity_photo['image_name'] ?>" alt="mytravelpartner.lk"  >
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $activity_photo['caption'] ?></h6>
                                                            <input type="hidden" name="sort[]"  value="<?php echo $activity_photo["id"]; ?>" class="sort-input"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
