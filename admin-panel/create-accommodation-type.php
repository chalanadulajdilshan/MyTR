...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Accommodation Type - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Accommodation Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="create-accommodation-type" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Create
                                                    </button>
                                                    <input type="hidden" name="create-accommodation-type">
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($ACCOMMODATION_TYPE->all() as $key => $accommodation_type) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $accommodation_type['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $accommodation_type['title'] ?></td>

                                                                <td>
                                                                    <a href="edit-accommodation-type.php?id=<?php echo $accommodation_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-accommodation-type" data-id="<?php echo $accommodation_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
