...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Vehicle Type - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Vehicle Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Vehicle Type" id="title" name="title">
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="create-vehicle-type" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Create
                                                    </button>
                                                    <input type="hidden" name="create-vehicle-type">
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($VEHICLE_TYPE->all() as $key => $vehicle_type) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $vehicle_type['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $vehicle_type['title'] ?></td>

                                                                <td>
                                                                    <a href="edit-vehicle-type.php?id=<?php echo $vehicle_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-vehicle-type" data-id="<?php echo $vehicle_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
