...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage All Restaurant - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage All Restaurants
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($RESTAURANT->all() as $key => $restaurant) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $restaurant['id'] ?>">
                                                                <td><?php echo $key ?></td>

                                                                <td><?php echo $restaurant['title']; ?> </td>
                                                                <td><?php echo $restaurant['contact_name']; ?></td>
                                                                <td><?php echo $restaurant['contact_number']; ?></td>
                                                                <td><?php echo $restaurant['email']; ?></td>
                                                                <?php
                                                                if ($restaurant['is_publish'] == 0) {
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    <a href="edit-restaurant.php.php?id=<?php echo $restaurant['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-tour-company" data-id="<?php echo $restaurant['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
