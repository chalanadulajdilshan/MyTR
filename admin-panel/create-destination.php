...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Destination - MyTravelPartner</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Destination
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12"  > 
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <label class="custom-file-label" for="main_img_tour">Select your  image</label>
                                                                </div> 
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
