...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit rent a car features - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Rent a car Features
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $FEATURE->title ?>">
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="update-rent-car-feature" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Update
                                                    </button>
                                                    <input type="hidden" id="id" value="<?php echo $id ?>" name="id">
                                                    <input type="hidden"    name="update-rent-car-feature"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
