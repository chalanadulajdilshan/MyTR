...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage All Accommodations - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage All Accommodations
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($ACCOMMODATION->all() as $key => $accommodation) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $accommodation['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php
                                                                ...
                                                                <td><?php echo substr($accommodation['title'],12); ?>.. </td>
                                                                <td><?php echo $accommodation['contact_name']; ?></td>
                                                                <td><?php echo $accommodation['mobile_number_1']; ?></td>
                                                                <?php
                                                                if ($accommodation['isPublished'] == 0) {
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="manage-rooms.php?id=<?php echo $accommodation['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="View Rooms" ><i class=" bx bx-bed succes-btn "></i></a> | 
