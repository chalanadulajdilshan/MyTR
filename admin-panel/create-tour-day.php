...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create tour day - MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Number of days" id="num_date" name="num_date"   >
                                                                </div>
                                                            </div>  
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $TOUR_PACKAGE->id ?>">
                                                                ...
                                                                <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                    <div class="card" >
                                                                        <div class="card-content" > 
                                                                            <img class="card-img-top img-fluid" src="../upload/tour-package/date/thumb/<?php echo $tour_date['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                            <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                                <h6 class=" text-left"><?php echo $tour_date['title'] ?></h6>
                                                                                <a href="edit-tour-day.php?id=<?php echo $tour_date['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                                ...
                                                                                <a href="create-tour-date-photo.php?id=<?php echo $tour_date['id']  ?>"  data-toggle="tooltip" data-placement="bottom" title="Add Photos"><i class=" bx bx-image info-btn"></i></a> | 
                                                                                <a href="#" class="delete-tour-package" data-id="<?php echo $tour_date['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
        ...
        <script src="js/ajax/tour-package-dates.js" type="text/javascript"></script>
