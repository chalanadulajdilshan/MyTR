...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit tour day - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Tour Date 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title"   value="<?php echo $TOUR_DATE->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Number of days</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Number of days" id="num_date" name="num_date"  value="<?php echo $TOUR_DATE->num_date ?>" >
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-12 form-group"    > 
                                                                ...
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $TOUR_DATE->image_name ?>">
                                                            ...
                                                            <div class="col-sm-4 " id="show-btn">    
                                                                <img src="../upload/tour-package/date/thumb/<?php echo $TOUR_DATE->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Description</label>
                                                                    <textarea id='description' name="description" > <?php echo $TOUR_DATE->description ?> </textarea>
                                                                </div>
                                                            </div>
                                                        </div> 
                                                    </div>  
                                                    ...
                                                    <input type="hidden"  value="<?php echo $TOUR_DATE->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
