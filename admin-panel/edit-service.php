...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Service - MyTravelPartner.lk</title>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $SERVICE->title ?>">
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-12 form-group"    > 
                                                                ...
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $SERVICE->image_name ?>">
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/service/<?php echo $SERVICE->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Short Description</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="short_description" name="short_description" value="<?php echo $SERVICE->short_description ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden"  value="<?php echo $SERVICE->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
