...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Album Photo - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Album Photo </a>
                                        </li>
                                        <li class="breadcrumb-item active">Arrange Album Photo
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/album-photo.php" method="POST" > 
                        <section id="draggable-cards">
                            <div class="row" id="card-drag-area">  
                                <?php
                                if (count($ALBUM_PHOTO->getAlbumPhotosById(1)) > 0) {
                                            ...
                                            <div class="back-basic-color">
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        <img class="card-img-top img-fluid" src="../upload/photo-album/gallery/thumb/<?php echo $album_photo["image_name"]; ?>" alt="mytravelpartner.lk"  >
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $album_photo['caption'] ?></h6>
