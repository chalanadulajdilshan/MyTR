...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Tour Date - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Tour Packages </a>
                                        <li class="breadcrumb-item"><a href="#"><?php echo $TOUR_PACKAGE->title ?> </a>
                                        </li>
                                        <li class="breadcrumb-item active">Arrange <?php echo $TOUR_PACKAGE->title ?>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/tour_date.php" method="POST" > 
                                                ...
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        ...
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $tour_date['title'] ?></h6>
                                                            <input type="hidden" name="sort[]"  value="<?php echo $tour_date["id"]; ?>" class="sort-input"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
