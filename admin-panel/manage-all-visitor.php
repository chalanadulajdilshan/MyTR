...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage Visitors - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage All Visitors
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($VISITOR->all() as $key => $visitors) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $visitors['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $visitors['full_name'] ?></td>
                                                                <td><?php echo $visitors['email'] ?></td>
                                                                <td><?php echo $visitors['phone_number'] ?></td>
                                                                
                                                                <?php
                                                                if ($visitors['is_active'] == 0) {
                                                                    ?>
                                                                ...
                                                                ?>
                                                                <td>
                                                                    <a href="edit-visitor.php?id=<?php echo $visitors['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-offer-duration" data-id="<?php echo $visitors['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
