...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Destination Photo - MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Destination Photo
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Caption</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $ATTRACTION_PHOTO->caption ?>">
                                                                </div>
                                                            </div>  

                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/attraction/gallery/thumb/<?php echo $ATTRACTION_PHOTO->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                    ...
                                                    <input type="hidden"  value="<?php echo $ATTRACTION_PHOTO->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
        ...
        <script src="js/ajax/attraction-photo.js" type="text/javascript"></script>
