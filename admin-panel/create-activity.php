...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Activity - MyTravelPartner</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Activity
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Map Code" id="map_code" name="map_code">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Location Highlights</label>
                                                                    <textarea id='location_highlight' name="location_highlight" > </textarea>
                                                                </div>
                                                            </div>
                                                        </div>  
                                                    </div>  
