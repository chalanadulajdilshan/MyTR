...
<html lang="en">
    ...
    <head>
        ...
        <title>Create Service Photo - Admin Panel</title>
        <!-- Favicon-->
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
                        <ul class="breadcrumb breadcrumb-style">
                            ...
                            <li class="breadcrumb-item active">Create Service Photo</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    <strong>Services</strong> <?php echo $SERVICE->title; ?></h2> 
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        <a href="manage-service.php"   role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="row">         
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    <strong>Service</strong> <?php echo $SERVICE->title; ?> Photos</h2> 
                                </h2> 
                            </div> 
                            ...
                            <div class="body">
                                <div  class="list-unstyled row clearfix">
                                    ...
                                    foreach ($SERVICE_PHOTO->getServicePhotosById($id) as $service_photo) {
                                        ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 " id="div<?php echo $service_photo['id'] ?>">
                                            <div class="aniimated-thumbnials">
                                                <a href="../upload/service/gallery/<?php echo $service_photo['image_name'] ?>" data-sub-html="<?php echo $service_photo['caption'] ?>">
                                                    <img class="img-responsive img-thumbnail" src="../upload/service//gallery//thumb/<?php echo $service_photo['image_name'] ?>" alt="">
                                                </a>
                                            </div>

                                            <div class="margin-top1">
                                                <a href="edit-service-photo.php?id=<?php echo $service_photo['id'] ?>&service=<?php echo $id ?>" class="btn btn-tbl-edit m-right" title="Edit"><i class="material-icons">create</i>  </a> | 
                                                <a href="arrange-service-photo.php?id=<?php echo $id ?>" class="btn btn-tbl-edit m-right btn-warning"><i class="material-icons" title="Arrange"> swap_horiz</i> </a> |   
                                                <a href="#" class="btn btn-tbl-delete delete-service-photo"  data-id="<?php echo $service_photo['id'] ?>"><i class="material-icons" title="Delete">delete_forever</i></a> 
                                            </div>
                                        </div> 
                                    <?php } ?>
                                </div>
        ...
        <!-- Custom Js -->       
        <script src="js/main-js/service-photo/service-photo.js" type="text/javascript"></script>
