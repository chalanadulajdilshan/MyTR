...
<html lang="en">
    ...
    <head>
        ...
        <title>Day Photo - Admin panel</title>
        <!-- Favicon-->
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
                        <ul class="breadcrumb breadcrumb-style">
                            ...
                            <li class="breadcrumb-item active">Create Tour Package  Photo</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    <strong>Album</strong>  Tour day photo</h2> 
                            </div>
                            <div class="body">
                ...
                <div class="row">         
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Manage <strong>Day Photos</strong>
                                </h2> 
                            </div> 
                            ...
                            <div class="body">
                                <div class="list-unstyled row clearfix">
                                    <?php
                                    $TOUR_DAY_PHOTO = new TourDatePhoto(NULL);
                                    foreach ($TOUR_DAY_PHOTO->getTourDatePhotosById($id) as $tour_day_photo) {
                                        ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 " id="div<?php echo $tour_day_photo['id'] ?>">
                                            <div class="aniimated-thumbnials">
                                                <img class="img-responsive img-thumbnail" src="../upload/tour-package/date/photo/thumb/<?php echo $tour_day_photo['image_name'] ?>" alt="">
                                            </div>

                                            <div class="margin-top1">
                                                <a href="edit-tour-date-photo.php?id=<?php echo $tour_day_photo['id']?>" class="btn btn-tbl-edit m-right" title="Edit"><i class="material-icons">create</i></a>| 
                                                <a href="arrange-tour-day-photo.php?id=<?php echo $id ?>" class="btn btn-tbl-edit m-right btn-warning"><i class="material-icons" title="Arrange"> swap_horiz</i></a>| 
                                                <a href="#" class="btn btn-tbl-delete delete-tour-date-photo" data-id=" <?php echo $tour_day_photo['id']?>"><i class="material-icons" title="Delete">delete_forever</i>    </a>
                                            </div>
                                        </div> 
                                    <?php } ?>
                                </div>
        ...
        <!-- Custom Js -->
        <script src="js/main-js/tour-package-date-photo/tour-package-date-photo.js" type="text/javascript"></script>
