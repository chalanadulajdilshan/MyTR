...
$id = '';
$id = $_GET['id'];
$TOUR_PACKAGE_PHOTO = new TourPackagePhoto($id);
?>
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Tour Package Photo - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Tour Package Photo
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>caption</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="caption" name="caption" value="<?php echo $TOUR_PACKAGE_PHOTO->caption ?>">
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-12 form-group"    > 
                                                                ...
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $TOUR_PACKAGE_PHOTO->image_name ?>">
                                                            ...
                                                            <div class="col-sm-4 " id="show-btn">    
                                                                <img src="../upload/tour-package/gallery/thumb/<?php echo $TOUR_PACKAGE_PHOTO->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                    ...
                                                    <input type="hidden"  value="<?php echo $TOUR_PACKAGE_PHOTO->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
