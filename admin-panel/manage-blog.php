...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage Blog - MyTravelPartner</title>
                                                   ...
                                                   $BLOG = new Blog(NULL);
                                                    if (count($BLOG) > 0) {
                                                        foreach ($BLOG->all() as $key => $blog) {
                                                            ?>
                                                            <div class="col-md-3 col-sm-6" id="div<?php echo $blog['id'] ?>">
                                                                <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                    <div class="card" >
                                                                        <div class="card-content" > 
                                                                            <img class="card-img-top img-fluid" src="../upload/blog/thumb/<?php echo $blog['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                            <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                                <h6 class=" text-left"><?php echo $blog['title'] ?></h6>
                                                                                <a href="edit-blog.php?id=<?php echo $blog['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                                <a href="arrange-blog.php"  data-toggle="tooltip" data-placement="bottom" title="Arrange"><i class=" bx bx-transfer succes-btn"></i></a> | 
                                                                                <a href="#" class="delete-activity" data-id="<?php echo $blog['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        ?>
                                                        <p class="text-danger text-bold-600 text-left">No blog images.</p>
                                                    <?php } ?>
                                                </div>
                                            </div>  
                                        </div>
