...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Offer Duration - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Offer Duration
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter dates" id="dates" name="dates">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Price</label>
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter Price" id="price" name="price">
                                                                </div>
                                                            </div>  
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($OFFER_DURATION->all() as $key => $offer_duration) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $offer_duration['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $offer_duration['title'] ?></td>
                                                                <td><?php echo $offer_duration['dates'] ?></td>
                                                                <td><?php echo $offer_duration['price'] ?></td>
                                                                <td>
                                                                    <a href="edit-offer-duration.php?id=<?php echo $offer_duration['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-offer-duration" data-id="<?php echo $offer_duration['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
