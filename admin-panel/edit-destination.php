...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Destination - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Destination
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $ATTRACTION->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Location</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="location" name="location" value="<?php echo $ATTRACTION->location ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12 form-group"    > 
                                                                <label>Edit your Image</label>
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $ATTRACTION->image_name ?>">
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/attraction/<?php echo $SLIDER->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Short Description</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="short_description" name="short_description" value="<?php echo $ATTRACTION->short_description ?>">
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea id='location_highlight' name="location_highlight" ><?php echo $ATTRACTION->description ?> </textarea>
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <input type="hidden"  value="<?php echo $ATTRACTION->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
