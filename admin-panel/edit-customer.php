...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Customer - MyTravelPartner.lk</title>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"   id="full_name" name="full_name" value="<?php echo $CUSTOMER->full_name ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter Email" id="email" name="email"  value="<?php echo $CUSTOMER->email ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Phone Number</label>
                                                                    <input type="number" min="0" class="form-control"   id="phone_number" name="phone_number"  value="<?php echo $CUSTOMER->phone_number ?>">
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                ...
                                                                <?php } else { ?>
                                                                    <img src="../upload/customer/<?php echo $CUSTOMER->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2; "/>
