...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Slider - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="create-slider.php">Slider</a>
                                        </li>

                                        <li class="breadcrumb-item active">Edit Slider
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $SLIDER->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12 form-group"    > 
                                                                <label>Edit your Slider Image</label>
                                                                <div class="custom-file">
                                                                    ...
                                                                    <label class="custom-file-label" for="main_img_tour">Click here to Edit slider image</label>
                                                                </div> 
                                                            </div>  
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/slider/<?php echo $SLIDER->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                        </div> 
                                                    </div>  
                                                    <hr>
                                                    ...
                                                    <input type="hidden"  value="<?php echo $SLIDER->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
