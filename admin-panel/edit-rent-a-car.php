...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Rent a car || MyTravelPartner.lk </title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Rent a car 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <div class="br">
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select2 form-control" name="type" id="type">
                                                                        ...
                                                                        foreach ($VEHICLE_TYPE->all() as $vehicle_type) {
                                                                            ...
                                                                            if ($RENT_CAR->type == $vehicle_type['id']) {
                                                                                ?>
                                                                                <option value="<?php echo $vehicle_type['id'] ?>" selected=""><?php echo $vehicle_type['title'] ?></option>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Title" name="title" id="title" value="<?php echo $RENT_CAR->title ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Registration Number</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Registration Number" id="reg_number" name="reg_number" value="<?php echo $RENT_CAR->reg_number ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Registration Year</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Registration Year" id="reg_year" name="reg_year" value="<?php echo $RENT_CAR->reg_year ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select2 form-control" id="fuel_type" name="fuel_type">
                                                                        ...
                                                                        <?php
                                                                        if ($RENT_CAR->fuel_type == "Diesel") {
                                                                            ?>
                                                                            <option value="Diesel" selected="">Diesel</option>
                                                                            <option value="Electrical">Electrical</option>
                                                                            <option value="Petrol">Petrol</option>
                                                                            <option value="Hybrid">Hybrid</option>
                                                                        <?php } if ($RENT_CAR->fuel_type == "Electrical") { ?>
                                                                            <option value="Diesel">Diesel</option>
                                                                            <option value="Electrical" selected="">Electrical</option>
                                                                            <option value="Petrol">Petrol</option>
                                                                            <option value="Hybrid">Hybrid</option>
                                                                        <?php } if ($RENT_CAR->fuel_type == "Petrol") { ?>
                                                                            <option value="Diesel">Diesel</option>
                                                                            <option value="Electrical">Electrical</option>
                                                                            <option value="Petrol" selected="">Petrol</option>
                                                                            <option value="Hybrid">Hybrid</option>
                                                                        <?php } if ($RENT_CAR->fuel_type == "Hybrid") { ?>
                                                                            <option value="Diesel">Diesel</option>
                                                                            <option value="Electrical">Electrical</option>
                                                                            <option value="Petrol">Petrol</option>
                                                            ...
                                                            <div class="row">  
                                                                ...
                                                                <div class="col-sm-4 col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Enter Contact name" value="<?php echo $RENT_CAR->contact_name ?>" name="contact_name" id="contact_name">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4 col-md-3">
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input type="email" class="form-control" placeholder="Enter your email" value="<?php echo $RENT_CAR->email ?>" name="email" id="email">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4  col-md-3">
                                                                    <div class="form-group">
                                                                        <label> Contact number</label>
                                                                        <input type="text" class="form-control" placeholder="Enter Contact number " value="<?php echo $RENT_CAR->contact_number ?>" id="contact_number" name="contact_number">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4  col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Alternative contact number (optional) </label>
                                                                        <input type="text" class="form-control" placeholder="Enter Contact number " id="contact_number_2" name="contact_number_2" value="<?php echo $RENT_CAR->contact_number_2 ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="br mb-2">
                                                        <div class="row">  
                                                            ...
                                                            <div class="col-sm-6" id="show-btn"> 
                                                                ...
                                                                <img src="../upload/rent-a-car/license/front/thumb/<?php echo $RENT_CAR->driving_license_front ?>" id="licen_front_img" style="box-shadow: 0 0 0 2px #0071c2;margin-top: 10px;"/>
                                                            ...
                                                            <div class="col-sm-6" id="show-btn"> 
                                                                ...
                                                                <img src="../upload/rent-a-car/license/back/thumb/<?php echo $RENT_CAR->driving_license_back ?>" id="licen_back_img" style="box-shadow: 0 0 0 2px #0071c2;margin-top: 10px;"/>
                                                    ...
                                                    <div class="br mb-2">
                                                        <div class="row">  
                                                            <div class="col-sm-4" id="show-btn"> 
                                                                ...
                                                                <img src="../upload/rent-a-car/gallery/thumb/<?php echo $RENT_CAR->main_image ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;"/>
                                            ...
                                            <div class="card-body">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select2 form-control" name="budget" id="budget">
                                                                        <?php
                                                                        if ($RENT_CAR->budget == 1) {
                                                                            ?>
                                                                            <option value="1" selected="">Vehicle Budget</option>
                                                                        ...
                                                                        if ($RENT_CAR->budget == 3) {
                                                                            ?>
                                                                            <option value="1">Vehicle Budget</option>
                                                                            <option value="2">Economy</option>
                                                                            <option value="3" selected="">Compact(mid sized car)</option>
                                                                            <option value="4">Premium(High luxurious)</option>
                                                                            <option value="5">Luxurious</option>
                                                                            <?php
                                                                        }
                                                                        if ($RENT_CAR->budget == 4) {
                                                                            ?>
                                                                            <option value="1">Vehicle Budget</option>
                                                                            <option value="2">Economy</option>
                                                                            <option value="3" >Compact(mid sized car)</option>
                                                                            <option value="4" selected="">Premium(High luxurious)</option>
                                                                            <option value="5">Luxurious</option>
                                                                            <?php
                                                                        }
                                                                        if ($RENT_CAR->budget == 5) {
                                                                            ?>
                                                                            <option value="1">Vehicle Budget</option>
                                                                            <option value="2">Economy</option>
                                                                            <option value="3" >Compact(mid sized car)</option>
                                                                            <option value="4" >Premium(High luxurious)</option>
                                                                            <option value="5" selected="">Luxurious</option>
                                                                        <?php } else { ?>
                                                                            <option value="1">Vehicle Budget</option>
                                                                            <option value="2">Economy</option>
                                                                            <option value="3" >Compact(mid sized car)</option>
                                                                    ...
                                                                    <div class="row pl-2 pt-1">
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"  id="air_condition"  value="1"  name="air_condition" <?php
                                                                            ...
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"    id="air_condition2"  value="0"  name="air_condition" <?php
                                                                                        if ($RENT_CAR->air_condition == 0) {
                                                                                            echo 'checked';
                                                                                        }
                                                                                        ?>>
                                                                    ...
                                                                    <div class="row pl-2 pt-1">
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"  id="transmission"  value="1" name="transmission" <?php
                                                                                        if ($RENT_CAR->transmission == 1) {
                                                                                            echo 'checked';
                                                                                        }
                                                                                        ?>>
                                                                            ...
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"    id="transmission1"  value="0" checked="" name="transmission" <?php
                                                                                        if ($RENT_CAR->transmission == 0) {
                                                                                            echo 'checked';
                                                                                        }
                                                                                        ?>>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group"> 
                                                                        <div class="d-inline-block mb-1 mr-1">
                                                                            <input type="number" class="touchspin" value="<?php echo $RENT_CAR->num_passengers ?>" name="num_passengers" id="num_passengers" min="1" >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group"> 
                                                                        <div class="d-inline-block mb-1 mr-1">
                                                                            <input type="number" class="touchspin"  value="<?php echo $RENT_CAR->num_baggaes ?>"  name="num_baggaes" id="num_baggaes" min="1">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group"> 
                                                                        <div class="d-inline-block mb-1 mr-1">
                                                                            <input type="number" class="touchspin" value="<?php echo $RENT_CAR->num_doors ?>"  name="num_doors" id="num_doors" min="1">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="origin" name="city" placeholder="Enter Your Vehicle Location" value="<?php echo $RENT_CAR->city ?>"  >
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="row pl-2 pt-1">
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"  id="airport_transfer"  value="1" name="airport_transfer" <?php
                                                                            ...
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"    id="airport_transfer1"  value="0"  name="airport_transfer" <?php
                                                                                        if ($RENT_CAR->airport_transfer == 0) {
                                                                                            echo 'checked';
                                                                                        }
                                                                                        ?> >
                                                                    ...
                                                                    <div class="row pl-2 pt-1">
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"  id="wedding_cars"  value="1" name="wedding_cars" <?php
                                                                            ...
                                                                            <li class="d-inline-block m-r-12 mb-1">
                                                                                <fieldset>
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" class="custom-control-input"    id="wedding_cars1"  value="0"   name="wedding_cars" <?php
                                                                                        if ($RENT_CAR->wedding_cars == 0) {
                                                                                            echo 'checked';
                                                                                        }
                                                                                        ?>>
                                                                ...
                                                                <div class="col-md-3 mb-1">
                                                                    <fieldset>
                                                                        <div class="checkbox checkbox-primary">
                                                                            <input type="checkbox" id="colorCheckboxf<?php echo $key ?>"  class="add-features" name="feature" data-id="<?php echo $features['id'] ?>" car="<?php echo $id ?>"   value="<?php echo $features['id'] ?>"  <?php
                                                                            foreach ($RENT_CAR_FEATURE->getFeaturesById($id) as $rent_car_feature) {
                                                                                if ($features['id'] == $rent_car_feature['feature']) {
                                                                                    echo 'checked';
                                                                                }
                                                                            }
                                                                            ?>>
                                                    ...
                                                    <div class="br mb-2">
                                                        ...
                                                        <textarea id="description" name="description" ><?php echo $RENT_CAR->description ?></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3 mb-1">
                                                            <fieldset>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6  ">
                                                            ...
                                                            <input type="hidden" name="create-feature">
                                                            <input type="hidden" name="id" value="<?php echo $id ?>">
                                                            <input type="hidden" name="old-image_name" value="<?php echo $RENT_CAR->main_image ?>">
                                                            <input type="hidden" name="old-image_name_license_front" value="<?php echo $RENT_CAR->driving_license_front ?>">
                                                            <input type="hidden" name="old-image_name_license_back" value="<?php echo $RENT_CAR->driving_license_back ?>"> 
                                                            <button class="btn btn-primary  " id="update" type="button" style="float: left">Update</button>
...
<script src="js/ajax/add-car-features.js" type="text/javascript"></script>
