...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Blog - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Arrange Blogs
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/blog.php" method="POST" > 
                                            ...
                                            <div class="back-basic-color">
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        <img class="card-img-top img-fluid" src="../upload/blog/<?php echo $blog['image_name'] ?>" alt="mytravelpartner.lk"  >
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $blog['title'] ?></h6>
                                                            <input type="hidden" name="sort[]"  value="<?php echo $blog["id"]; ?>" class="sort-input"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
