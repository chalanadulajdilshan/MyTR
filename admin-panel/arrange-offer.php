...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Arrange Offers - MyTravelPartner.lk</title>
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Arrange Offers
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body"> 
                    ...
                    ?>
                    <form action="post-and-get/ajax/offers.php" method="POST" > 
                                                ...
                                                <div class="card" >
                                                    <div class="card-content" > 
                                                        ...
                                                        <div class="card-body"  id="basic-body">
                                                            <h6 class=" text-center"><?php echo $offer['title'] ?></h6>
