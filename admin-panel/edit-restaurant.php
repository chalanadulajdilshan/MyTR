...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Restaurant || <?php echo $REASTURANT->title ?> || MyTravelPartner.lk </title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Restaurant - " <?php echo $REASTURANT->title ?> "
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body"> 
                                            <fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Restaurant Name" name="title" id="title" readonly="" value="<?php echo $REASTURANT->title ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="address_1" name="address_1" placeholder="Unit Number, suite floor, Bulding" readonly=""  value="<?php echo $REASTURANT->address_1 ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Address Line 2</label>
                                                                <input type="text" class="form-control" id="address_2" name="address_2" placeholder="Street name" readonly=""  value="<?php echo $REASTURANT->address_2 ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>city</label>
                                                                <select class="select2 form-control" name="city" id="city" readonly="" >
                                                                    <option value="" selected="">Select Your City</option>
                                                                    <?php
                                                                    $CITY = new City(NULL);
                                                                    foreach ($CITY->all() as $city) {
                                                                        if ($city['id'] == $REASTURANT->city) {
                                                                            ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                $CITY_ZIP = new City($REASTURANT->city);
                                                                ?>
                                                                <input type="text" class="form-control" name="zip_code" id="zip_code" readonly=""  placeholder="Enter Your Zip code" readonly="" value="<?php echo $CITY_ZIP->postcode ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">  
                                                        ...
                                                        <div class="col-sm-4 col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Enter Contact name" readonly=""  value="<?php echo $REASTURANT->contact_name ?>" name="contact_name" id="contact_name">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-md-3">
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="email" class="form-control" placeholder="Enter your email" readonly=""  value="<?php echo $REASTURANT->email ?>" name="email" id="email">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4  col-md-3">
                                                            <div class="form-group">
                                                                <label> Contact number</label>
                                                                <input type="text" class="form-control mobile_number" placeholder="Enter Contact number " readonly=""  value="<?php echo $REASTURANT->contact_number ?>" id="contact_number" name="contact_number">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4  col-md-4">
                                                            <div class="form-group">
                                                                <label>Alternative contact number (optional) </label>
                                                                <input type="text" class="form-control mobile_number" placeholder="Enter Contact number " readonly=""  id="contact_number_2" name="contact_number_2"  value="<?php echo $REASTURANT->contact_number_2 ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="br mb-2">
                                                    <div class="row">  
                                                        <div class="col-sm-4" id="show-btn"> 
                                                            ...
                                                            <input type="hidden" id="del-restaurant-img"  >
                                                            <img src="../upload/restaurant/main/gallery/thumb/<?php echo $REASTURANT->main_image ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;"/>
                                                    ...
                                                    <div class="row"> 
                                                            ...
                                                            <div class="col-md-3 mb-1">
                                                                <fieldset>                                                                
                                                                    <div class="checkbox checkbox-primary">
                                                                        <input type="checkbox" id="colorCheckboxf<?php echo $key ?>"   name="serve[]" value="<?php echo $key ?>" <?php
                                                                        foreach (explode(",", $REASTURANT->serve_types) as $serve_type) {
                                                                            if ($serve_type == $key) {
                                                                                echo 'checked';
                                                                            }
                                                                        }
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <fieldset class="form-group position-relative has-icon-left">
                                                                <input type="text" class="form-control pickatime" placeholder="Select Time" value="<?php echo $REASTURANT->open_time ?>" name="open_time" id="open_time"  >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <fieldset class="form-group position-relative has-icon-left">
                                                                <input type="text" class="form-control pickatime" placeholder="Select Time" value="<?php echo $REASTURANT->close_time ?>" name="close_time" id="close_time">
                                                                <div class="form-control-position">
                                                                    <i class='bx bx-history'></i>
                                                                </div>
                                                            </fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                <select class="select2 form-control select-light-danger" multiple="multiple" name="closing_dates[]" >
                                                                    ...
                                                                    foreach ($DEFAULTDATA->getCloseDays() as $key => $getcloseday) {
                                                                        foreach (explode(",", $REASTURANT->close_days) as $close_days) {
                                                                            if ($close_days == $key) {
                                                                                ?>
                                                ...
                                                <div class="br mb-2">
                                                    ...
                                                    <textarea id="description" name="description"><?php echo $REASTURANT->description ?></textarea>
                                                </div>
                                                <div class="row">

                                                    <div class="col-sm-6">  
                                                        <h6>Activate or Deactivate Restaurant </h6>  

                                                        <div class="checkbox checkbox-primary mt-1">
                                                            <input type="checkbox" id="is_active"   name="is_active" value="1" <?php
                                                            if ($REASTURANT->is_publish == 1) {
                                                                echo 'checked=""';
                                                            }
                                                            ?>>
                                                    ...
                                                    <div class="col-md-6 mt-30">     
                                                        <button class="btn btn-primary  " id="active_company" type="button" style="float: right">Update</button> 
                                                        <input type="hidden" name="active_company">
