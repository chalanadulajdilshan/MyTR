                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Tour Package
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="br">
                                                <div class="row"> 
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Dates</label>
                                                            <input type="text" class="form-control" placeholder="Enter Dates" id="dates" name="dates">
                                                        </div>
                                                    </div>  
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id='include_and_exclude' name="include_and_exclude" >  </textarea>
                                                        </div>
                                                    </div>  
