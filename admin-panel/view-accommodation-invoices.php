...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>View Booking - MyTravelPartner.lk</title>
                ...
                <div class="content-body"><!-- invoice list -->
                    <section class="invoice-list-wrapper">
                        ...
                        <div class="invoice-create-btn mb-1">
                            <a href="send-invoice.php" target="_blank" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true">Create
                                Invoice</a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table invoice-data-table dt-responsive nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($HOTEL_BOOKING->getBookingdByAccId($id) as $hotel_booking) {
