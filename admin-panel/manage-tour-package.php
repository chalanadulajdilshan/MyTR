...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage Tour Packages - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active"> Manage Tour Packages By - <span class="text-danger"> " <?php echo $TOUR_TYPE->title?> " </span>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="br"> 
                                                <div class="row">
                                                    ...
                                                    if (count($TOUR_PACKAGE) > 0) {
                                                        foreach ($TOUR_PACKAGE->getTourPackageById($id) as $key => $tour_packages) {
                                                            ?>
                                                            <div class="col-md-3 col-sm-6" id="div<?php echo $tour_packages['id'] ?>">
                                                                <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                    <div class="card" >
                                                                        <div class="card-content" > 
                                                                            <img class="card-img-top img-fluid" src="../upload/tour-package/thumb/<?php echo $tour_packages['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                            <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                                <h6 class=" text-left"><?php echo $tour_packages['title'] ?></h6>
                                                                                <a href="edit-tour-package.php?id=<?php echo $tour_packages['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                                <a href="arrange-tour-package.php?id=<?php echo $id ?>"  data-toggle="tooltip" data-placement="bottom" title="Arrange"><i class=" bx bx-transfer succes-btn"></i></a> | 
                                                                                <a href="create-tour-day.php?id=<?php echo $tour_packages['id'] ?>"  data-toggle="tooltip" data-placement="bottom" title="Manage Tour Dates"><i class=" bx bx-map-pin warring-btn"></i></a> | 
                                                                                <a href="create-tour-package-photo.php?id=<?php echo $tour_packages['id'] ?>"  data-toggle="tooltip" data-placement="bottom" title="Add Photos"><i class=" bx bx-image info-btn"></i></a> | 
