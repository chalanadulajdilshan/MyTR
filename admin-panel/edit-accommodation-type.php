...
$id = '';
$id = $_GET['id'];
$ACCOMMODATION_TYPE = new AccommodationType($id);
?>
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Accommodation Type - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Accommodation Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $ACCOMMODATION_TYPE->title ?>">
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="update-accommodation-type" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Update
                                                    </button>
                                                    <input type="hidden" name="update-accommodation-type">
