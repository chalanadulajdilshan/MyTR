...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Accommodation Facility - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Accommodation Facility
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Icon" id="icion" name="icion">
                                                                </div>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="create-facility" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Create
                                                    </button>
                                                    <input type="hidden" name="create-facility">
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($fACILITY->all() as $key => $facility) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $facility['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php
                                                                    $DEFAULTDATA = new DefaultData(NULL);
                                                                    foreach ($DEFAULTDATA->getFacilityType() as $key => $facility_type) {
                                                                ...
                                                                <td><?php echo $facility['icion'] ?></td>

                                                                <td>
                                                                    <a href="edit-accommodation-facility.php?id=<?php echo $facility['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-facility" data-id="<?php echo $facility['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
