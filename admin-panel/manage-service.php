...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage Service - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active"> Manage Service 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                   ...
                                                   $SERVICE = new Service(NULL);
                                                    if (count($SERVICE) > 0) {
                                                        foreach ($SERVICE->all() as $key => $service) {
                                                            ?>
                                                            <div class="col-md-3 col-sm-6" id="div<?php echo $service['id'] ?>">
                                                                <div   style="background-color: #f2f4f4;margin-bottom: 25px;">
                                                                    <div class="card" >
                                                                        <div class="card-content" > 
                                                                            <img class="card-img-top img-fluid" src="../upload/service/<?php echo $service['image_name'] ?>" alt="mytravelpartner.lk"  >

                                                                            <div class="card-body" style="padding: 10px; background-color: #f2f4f4;" >
                                                                                <h6 class=" text-left"><?php echo $service['title'] ?></h6>
                                                                                <a href="edit-service.php?id=<?php echo $service['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                                <a href="arrange-services.php"  data-toggle="tooltip" data-placement="bottom" title="Arrange"><i class=" bx bx-transfer succes-btn"></i></a> | 
                                                                                <a href="#" class="delete-service" data-id="<?php echo $service['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        ?>
                                                        <p class="text-danger text-bold-600 text-left">No services images.</p>
                                                    <?php } ?>
                                                </div>
                                            </div>  
                                        </div>
