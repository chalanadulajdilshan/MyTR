...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Amenities Type - MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Amenities Type
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="create-amenities-type" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Create
                                                    </button>
                                                    <input type="hidden" name="create-amenities-type">
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($AMENITIES_TYPE->all() as $key => $amenities_type) {
                                                            $key++;
                                                            ?>
                                                            <tr id="div<?php echo $amenities_type['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $amenities_type['title'] ?></td>

                                                                <td>
                                                                    <a href="edit-amenities-type.php?id=<?php echo $amenities_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="create-amenities.php?id=<?php echo $amenities_type['id'] ?>"  data-toggle="tooltip" data-placement="bottom" title="Add Aminities"><i class=" bx bx-home info-btn"></i></a> | 

                                                                    <a href="#" class="delete-amenities-type" data-id="<?php echo $amenities_type['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
        ...
        <script src="delete/js/amenities-type.js" type="text/javascript"></script>
    </body>
