...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create Pages - MyTravelPartner</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Pages
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($PAGES->all() as $key => $pages) {
                                                            ...
                                                            <tr id="div<?php echo $pages['id'] ?>">
                                                                ...
                                                                <td><?php echo $pages['short_description'] ?></td>

                                                                <td>
                                                                    <a href="edit-page.php?id=<?php echo $pages['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-page" data-id="<?php echo $pages['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
        ...
        <script src="delete/js/page.js" type="text/javascript"></script>
        <script>
            tinymce.init({
