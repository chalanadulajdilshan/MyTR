...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage Rent a car - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage Rent Car Vehicles in - <span class="text-danger"> " <?php echo $RENT_CAR_COMPANY->title ?> " </span> Company
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-content"  >
                                            ...
                                            <div class="card-body" style="padding: 10px;">
                                                ...
                                                <a href="view-rent-a-car-photo.php?id=<?php echo $rentcar['id'] ?>"  data-toggle="tooltip" data-placement="bottom" title="Manage Vehicle"><i class=" bx bx-image succes-btn"></i></a>   
