...
$id = '';
$id = $_GET['id'];
$OFFER_DURATION = new OfferDuration($id);
?>
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Offer Duration - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Offer Duration
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row"> 
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $OFFER_DURATION->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Number of Dates</label>
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter dates" id="dates" name="dates"  value="<?php echo $OFFER_DURATION->dates ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Price</label>
                                                                    <input type="number" min="0" class="form-control" placeholder="Enter Price" id="price" name="price"  value="<?php echo $OFFER_DURATION->price ?>">
                                                                </div>
                                                            </div>  
                                                    ...
                                                    <input type="hidden"   name="id" value="<?php echo $OFFER_DURATION->id ?>"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
