...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create rent a car features - MyTravelPartner.lk</title>
    ...
    <body class="someBlock vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Create Rent a car Features
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="create-rent-car-feature" style="float: right;color: white">
                                                        <span class=" spinner-border-sm" role="status" aria-hidden="true"></span>
                                                        Create
                                                    </button>
                                                    <input type="hidden" name="create-rent-car-feature">
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
                                                ...
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($FEATURE->all() as $key => $features) {
                                                            $key++;
                                                            ?> 
                                                            <tr id="div<?php echo $features['id'] ?>">
                                                                <td><?php echo $key ?></td>
                                                                <td><?php echo $features['title'] ?></td>

                                                                <td>
                                                                    <a href="edit-rent-car-features.php?id=<?php echo $features['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                                    <a href="#" class="delete-features" data-id="<?php echo $features['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
        ...
        <script src="delete/js/features.js" type="text/javascript"></script>
