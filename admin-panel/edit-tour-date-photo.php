...
$TOUR_DAY_PHOTO = new TourDatePhoto($id);
?>
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Tour Date Photo - MyTravelPartner.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Tour Date Photo
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Caption</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="caption" name="title" value="<?php echo $TOUR_DAY_PHOTO->caption ?>">
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-sm-4 " id="show-btn">    
                                                                <img src="../upload/tour-package/date/photo/thumb/<?php echo $TOUR_DAY_PHOTO->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                    ...
                                                    <button class="btn btn-warning mb-1" type="button" id="update"   style="float: right;color: white;margin-top: 10px;">
                                                    ...
                                                    <input type="hidden"  value="<?php echo $TOUR_DAY_PHOTO->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
