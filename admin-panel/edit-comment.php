...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Comment - MyTravelPartner.lk</title>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $COMMENT->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Name</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Name" id="name" name="name" value="<?php echo $COMMENT->name ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12 form-group"    > 
                                                                <label>Edit your Image</label>
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $COMMENT->image_name ?>">
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/comment/<?php echo $COMMENT->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 

                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Description</label>
                                                                    <textarea id='description' name="description" ><?php echo $COMMENT->description ?> </textarea>
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-6">  
                                                    ...
                                                    <input type="hidden"  value="<?php echo $COMMENT->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
