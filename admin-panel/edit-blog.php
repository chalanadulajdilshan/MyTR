...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Edit Blog - MyTravelPartner.lk</title>
                                        ...
                                        <div class="card-body">
                                            <form action="#" class="wizard-horizontal form repeater-default" id="form-data">
                                                <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="title" name="title" value="<?php echo $BLOG->title ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Location</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="location" name="location" value="<?php echo $BLOG->location ?>">
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-12 form-group"    > 
                                                                <label>Edit your Image</label>
                                                                <div class="custom-file">
                                                                    <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $BLOG->image_name ?>">
                                                            ...
                                                            <div class="col-sm-8 " id="show-btn">    
                                                                <img src="../upload/blog/<?php echo $BLOG->image_name ?>" id="main-img" style="box-shadow: 0 0 0 2px #0071c2;width: 100%"/>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Short Description</label>
                                                                    <input type="text" class="form-control" placeholder="Enter Title" id="short_description" name="short_description" value="<?php echo $BLOG->short_description ?>">
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Date</label>
                                                                    <input type="text" class="form-control datepicker" placeholder="Enter Date" id="date" name="date" value="<?php echo $BLOG->date ?>">
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden"  value="<?php echo $BLOG->image_name; ?>" name="oldImageName"/>
                                                </fieldset> 
                                            </form> 
                                        </div>
                                    </div>
